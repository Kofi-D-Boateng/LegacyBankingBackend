...
public class TransactionNotification implements Serializable {
    ...
    public TransactionNotification(String email, TransactionType type, Long dateOfTransaction, Double amount) {
        this.email = email;
        this.type = type;
    ...
    public TransactionNotification(String email, TransactionType type, Long dateOfTransaction, Double amount, String receiver, String sender, boolean isReceiverInDatabase) {
        this.email = email;
        this.type = type;
        this.dateOfTransaction = dateOfTransaction;
        this.amount = amount;
